      ...
      <div className="dash-content-row" style={{ flex: 1, minWidth: 0, padding: "24px 32px", display: "flex", gap: 24, height: "100%", overflow: "hidden" }}>
          <div className="dash-main-col" style={{ flex: 1, minWidth: 0, height: "100%", overflowY: "auto", paddingRight: 4 }}>
            ...
            <div className="dash-stat-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", gap: 14, marginBottom: 12 }}>
              ...
              <div style={{ minWidth: 0, gridColumn: "4 / span 1", background: CARD_BG, borderRadius: 22, padding: 18 }}>
                <div style={{ fontSize: 13, color: "#2C2A26", marginBottom: 10 }}>Top Clients</div>
                {topClients.length === 0 ? (
            ...
            <div className="dash-row-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, minmax(0, 1fr))", gap: 10 }}>
              <div style={{ minWidth: 0, gridColumn: "1 / span 2", background: CARD_BG, borderRadius: 22, padding: 18 }}>
              ...
              <div style={{ minWidth: 0, gridColumn: "3 / span 2", background: CARD_BG, borderRadius: 22, padding: 18 }}>
                <div style={{ fontSize: 13, color: "#2C2A26", marginBottom: 10 }}>Top Products</div>
